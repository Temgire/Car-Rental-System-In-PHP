	<li class="about">
					<p>I have organized company that rents cars and other vehicles to clients at lower costs. We we are here to serve every indian Citizen</p>
					<ul>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by Dinesh Temgire
		</div>
	</footer><!--  end footer  -->
